...
def seed_data():
    ...
    products = [
        ...
        {'nome': "Nike Saturn", "descricao": "Conforto de um astronauta", "estoque": 5, "preco": 340.99}, 
    ]
    for product in products:
        # Adição da chamada da função models.ItemDB.create no loop for
...
def seed_data_endpoint(db: Session = Depends(database.get_db)):
    seed_data(db)
